...
def easy():
    ...
    easyQ = [
                 [
                     "1.The range of modulating frequency for Narrow Band FM is ___________.",
                     "a) 30 Hz  to 15 KHz",
                     "b) 30 Hz  to 30 KHz",
                     "c) 30 Hz  to 3 KHz",
                     "d) 3 KHz to 30 KHz"
                 ...
                 [
                    "2.What is the maximum frequency deviation allowed in commercial FM broadcasting?",
                    "a) 100 KHz",
                    "b) 75 KHz",
                    "c) 15 KHz",
                    "d) 120 KHz"
                ...
                [
                    "3.Narrow band FM has the characteristics?" ,
                ...
                [
                    "4.The Varactor diode is usually ___________." ,
                    "a) Unbiased",
                    "b) Reverse biased",
                    "c) Forward biased",
                ...
                [
                    "5.The modulation index of a wideband FM system is ___________." ,
                    "a) >1",
                    "b) <1",
                    "c) =1",
                    "d) Same as Narrow-band FM"
                ]
            ]
    answer = [
                "c) 30 Hz  to 3 KHz",
...
def medium():
    ...
    mediumQ = [
                [
                    "12.What are the applications of Varactor Diode?",
                     "a) Band Pass Filters",
                ...
                [
                    "13.What is /are the advantages of Narrowband FM?",
                    "a)Less radiated power",
                    "b) Well defined service areas for given transmitter power",
                    "c)Both a) and b)",
                    "d)Only b)"
                ],
                [
                    "14.Narrow band frequency modulated wave occupies lesser bandwidth than wide band FM.",
                    "a) TRUE",
                    "b) FALSE",
                    "c) Neither a) or b)",
                ...
                [
                    "43.The modulation index of a narrow band FM signal is",
                ...
                [
                    "41.Which of the following is not true for UWB?",
                    "a) Large spectrum",
                    "b) Lower price",
                    "c) Pulse data",
...
def difficult():
    ...
    [
        "38.In radio receivers, varactor diodes are used for",
        "a. Tuning",
        "b. Demodulation",
        "c. Mixing",
        "d. None of the above	"
    ...
    [
     "36.Drawbacks of Tuned Radio Receiver are",
